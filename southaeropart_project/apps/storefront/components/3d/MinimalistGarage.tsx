...
export function MinimalistGarage() {
  ...
  const materials = useMemo(() => {
    return {
      ...
      showroomGlass: new THREE.MeshPhysicalMaterial({
  ...
  return (
    <group position={[0, 0, 0]}>
      {/* 1. GLOSSY WHITE REFLECTIVE SHOWROOM FLOOR */}
      ...
      {/* Front line */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[0, 0.001, 2.8]} material={materials.floorTrack}>
      ...
      {/* Left line */}
      <mesh rotation={[-Math.PI / 2, 0, 0]} position={[-1.5, 0.001, 0]} material={materials.floorTrack}>
      ...
      <group position={[0, 2.9, -7.5]}>
        ...
        {[-13, -8.66, -4.33, 0, 4.33, 8.66, 13].map((mx, idx) => (
          <mesh key={`bm-${idx}`} position={[mx, 0, 0]} material={materials.windowMullion}>
      ...
      <group position={[-9.5, 2.9, -1.5]} rotation={[0, Math.PI / 2, 0]}>
        ...
        {[-6, -3, 0, 3, 6].map((mx, idx) => (
          <mesh key={`lm-${idx}`} position={[mx, 0, 0]} material={materials.windowMullion}>
            <boxGeometry args={[0.06, 5.6, 0.12]} />
          </mesh>
        ))}
      </group>
      ...
      <group position={[9.5, 2.9, -1.5]} rotation={[0, -Math.PI / 2, 0]}>
        ...
        {/* Vertical Mullions */}
        {[-6, -3, 0, 3, 6].map((mx, idx) => (
          <mesh key={`rm-${idx}`} position={[mx, 0, 0]} material={materials.windowMullion}>
            <boxGeometry args={[0.06, 5.6, 0.12]} />
          </mesh>
        ))}
      </group>
      ...
      <mesh position={[0, 3.0, -11.0]}>
        ...
        <meshBasicMaterial color="#edf2f7" />
      </mesh>
      <mesh position={[-13.0, 3.0, -1.5]} rotation={[0, Math.PI / 2, 0]}>
      ...
      <mesh position={[0, 5.8, 0]} rotation={[Math.PI / 2, 0, 0]} material={materials.ceiling}>
        <planeGeometry args={[38, 38]} />
      </mesh>
      ...
      <group position={[0, 4.1, 0]}>
        ...
        {[
          ...
          <mesh key={i} position={[cx, 0.85, cz]} material={materials.whiteStructure}>
