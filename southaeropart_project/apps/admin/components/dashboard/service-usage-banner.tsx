...
import { Activity, ArrowRight, Database, Users, HardDrive } from "lucide-react";
import { getCachedServiceUsageMetrics } from "@/actions/service-usage.actions";

export async function ServiceUsageBanner() {
  let serviceStatus = {
    neonUsed: "8.56 MB",
    neonPercent: 1.67,
    clerkUsers: 3,
